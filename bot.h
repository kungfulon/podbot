...
#define PBMM_VERSION_STRING		"V3B23a"    // KWo - 29.07.2018
   ...
   #define snprintf_s(a, b, c, ...) snprintf(a, b, c, __VA_ARGS__)
   #define vsprintf_s(a, b, c, ...) vsprintf(a, b, c, __VA_ARGS__)
   #define vsnprintf_s(a, b, c, ...) vsnprintf(a, b, c, __VA_ARGS__)
...
#define TASKPRI_SPRAYLOGO 38.0f
#define TASKPRI_FOLLOWUSER 39.0f
#define TASKPRI_MOVETOPOSITION 50.0f
#define TASKPRI_DEFUSEBOMB 88.0f  // KWo - 16.12.2007
#define TASKPRI_PLANTBOMB 89.0f
#define TASKPRI_ATTACK 90.0f
#define TASKPRI_SEEKCOVER 91.0f
...
#define TIME_GRENPRIME 2.2f
#define MAX_KILL_HIST 16

#define BOMBMAXHEARDISTANCE 1536.0f
